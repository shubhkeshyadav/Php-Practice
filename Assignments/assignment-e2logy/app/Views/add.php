        ...
        <h2>Add new record</h2>
            <form class="form-horizontal" autocomplete="off" method="post" id="add_user_frm">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input required type="text" class="form-control" placeholder="Employee name" name="employee_name" id="employee_name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">          
                        <input required type="text" class="form-control" placeholder="Email address" name="email_address" id="email_address">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">          
                        <input required value="male" type="radio" id='male' name='gender' checked="true"><label for='male'>&nbsp&nbspMale&nbsp&nbsp</label>
                        <input value="female" required type="radio" id='female' name='gender'> <label for='female'>&nbspFemale</label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">          
                        <input required type="text" class="form-control" placeholder="Contact number" name="contact_number" id="contact_number">
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">          
                        ...
                        <?php
                            if($hobbies)
                            {
                                ...
                                {
                                    echo '<option value="'.$hobbie['id'].'">'.$hobbie['name'].'</option>';
                                }
                            }
                        ?>
                        </select>
...
<script>
        $(document).ready(function(){
            $('#add_user_frm').submit(function(evt){
                ...
                $.ajax({
                    url     :   'user.php?action=useradd&type=save',
                    type    :   'POST',
                    cache       : false,
                    contentType : false,
                    processData : false,
